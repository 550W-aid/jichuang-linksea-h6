...
module bilateral_3x3_stream_std #(
    ...
    input  wire [MAX_LANES*PIX_W_IN-1:0]  s_data,  // input RGB stream
    input  wire [MAX_LANES-1:0]           s_keep,  // lane keep mask
    ...
    output reg  [MAX_LANES*PIX_W_OUT-1:0] m_data,  // filtered grayscale pixel
    ...
    reg                              meta_s7_eof;
    reg                              meta_s7_valid;
    reg  [MAX_LANES-1:0]             meta_s8_keep;
    reg                              meta_s8_sof;
    reg                              meta_s8_eol;
    reg                              meta_s8_eof;
    reg                              meta_s8_valid;
    reg  [MAX_LANES-1:0]             meta_s9_keep;
    reg                              meta_s9_sof;
    reg                              meta_s9_eol;
    reg                              meta_s9_eof;
    reg                              meta_s9_valid;
    reg  [MAX_LANES-1:0]             meta_s10_keep;
    reg                              meta_s10_sof;
    reg                              meta_s10_eol;
    reg                              meta_s10_eof;
    reg                              meta_s10_valid;
    reg  [MAX_LANES-1:0]             meta_s11_keep;
    reg                              meta_s11_sof;
    reg                              meta_s11_eol;
    reg                              meta_s11_eof;
    reg                              meta_s11_valid;
    reg  [MAX_LANES-1:0]             meta_s12_keep;
    reg                              meta_s12_sof;
    reg                              meta_s12_eol;
    reg                              meta_s12_eof;
    reg                              meta_s12_valid;
    ...
    assign meta_s12_ready = stage_ready;
    assign meta_s11_ready = (~meta_s11_valid) | meta_s12_ready;
    assign meta_s10_ready = (~meta_s10_valid) | meta_s11_ready;
    assign meta_s9_ready  = (~meta_s9_valid)  | meta_s10_ready;
    assign meta_s8_ready  = (~meta_s8_valid)  | meta_s9_ready;
    assign meta_s7_ready  = (~meta_s7_valid)  | meta_s8_ready;
    ...
    // Keep frame-control metadata aligned with the deeper bilateral core
    // pipeline so pixel/control timing stays consistent at the module output.
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            meta_s7_eof    <= 1'b0;
            meta_s8_valid  <= 1'b0;
            meta_s8_keep   <= {MAX_LANES{1'b0}};
            meta_s8_sof    <= 1'b0;
            meta_s8_eol    <= 1'b0;
            meta_s8_eof    <= 1'b0;
            meta_s9_valid  <= 1'b0;
            meta_s9_keep   <= {MAX_LANES{1'b0}};
            meta_s9_sof    <= 1'b0;
            meta_s9_eol    <= 1'b0;
            meta_s9_eof    <= 1'b0;
            meta_s10_valid <= 1'b0;
            meta_s10_keep  <= {MAX_LANES{1'b0}};
            meta_s10_sof   <= 1'b0;
            meta_s10_eol   <= 1'b0;
            meta_s10_eof   <= 1'b0;
            meta_s11_valid <= 1'b0;
            meta_s11_keep  <= {MAX_LANES{1'b0}};
            meta_s11_sof   <= 1'b0;
            meta_s11_eol   <= 1'b0;
            meta_s11_eof   <= 1'b0;
            meta_s12_valid <= 1'b0;
            meta_s12_keep  <= {MAX_LANES{1'b0}};
            meta_s12_sof   <= 1'b0;
            meta_s12_eol   <= 1'b0;
            meta_s12_eof   <= 1'b0;
            m_valid        <= 1'b0;
            ...
            if (meta_s8_ready) begin
                meta_s8_valid <= meta_s7_valid;
                if (meta_s7_valid) begin
                    meta_s8_keep <= meta_s7_keep;
                    meta_s8_sof  <= meta_s7_sof;
                    meta_s8_eol  <= meta_s7_eol;
                    meta_s8_eof  <= meta_s7_eof;
                end else begin
                    meta_s8_keep <= {MAX_LANES{1'b0}};
                    meta_s8_sof  <= 1'b0;
                    meta_s8_eol  <= 1'b0;
            ...
            if (meta_s9_ready) begin
                meta_s9_valid <= meta_s8_valid;
                if (meta_s8_valid) begin
                    meta_s9_keep <= meta_s8_keep;
                    meta_s9_sof  <= meta_s8_sof;
                    meta_s9_eol  <= meta_s8_eol;
                    meta_s9_eof  <= meta_s8_eof;
                end else begin
                    meta_s9_keep <= {MAX_LANES{1'b0}};
                    meta_s9_sof  <= 1'b0;
                    meta_s9_eol  <= 1'b0;
            ...
            if (meta_s10_ready) begin
                meta_s10_valid <= meta_s9_valid;
                if (meta_s9_valid) begin
                    meta_s10_keep <= meta_s9_keep;
                    meta_s10_sof  <= meta_s9_sof;
                    meta_s10_eol  <= meta_s9_eol;
                    meta_s10_eof  <= meta_s9_eof;
                end else begin
                    meta_s10_keep <= {MAX_LANES{1'b0}};
                    meta_s10_sof  <= 1'b0;
                    meta_s10_eol  <= 1'b0;
            ...
            if (meta_s11_ready) begin
                meta_s11_valid <= meta_s10_valid;
                if (meta_s10_valid) begin
                    meta_s11_keep <= meta_s10_keep;
                    meta_s11_sof  <= meta_s10_sof;
                    meta_s11_eol  <= meta_s10_eol;
                    meta_s11_eof  <= meta_s10_eof;
                end else begin
                    meta_s11_keep <= {MAX_LANES{1'b0}};
                    meta_s11_sof  <= 1'b0;
                    meta_s11_eol  <= 1'b0;
            ...
            if (meta_s12_ready) begin
                meta_s12_valid <= meta_s11_valid;
                if (meta_s11_valid) begin
                    meta_s12_keep <= meta_s11_keep;
                    meta_s12_sof  <= meta_s11_sof;
                    meta_s12_eol  <= meta_s11_eol;
                    meta_s12_eof  <= meta_s11_eof;
                end else begin
                    meta_s12_keep <= {MAX_LANES{1'b0}};
                    meta_s12_sof  <= 1'b0;
                    meta_s12_eol  <= 1'b0;
