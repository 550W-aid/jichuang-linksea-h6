...
module affine_nearest_stream_std #(
    ...
    always @* begin
        ...
        if (out_x_q < IMG_WIDTH_U16) begin
            remaining_width_v = IMG_WIDTH_U16 - out_x_q;
        ...
        if ((state_q == ST_OUTPUT) && (out_y_q < IMG_HEIGHT_U16) && (beat_lane_count_v != {BEAT_COUNT_W{1'b0}})) begin
            plan_valid_v = 1'b1;
            for (lane_idx = 0; lane_idx < MAX_LANES; lane_idx = lane_idx + 1) begin
            ...
            plan_eof_v = (out_y_q == (IMG_HEIGHT_U16 - 16'd1)) && plan_eol_v;
            if (plan_eol_v) begin
                next_out_x_v = 16'd0;
