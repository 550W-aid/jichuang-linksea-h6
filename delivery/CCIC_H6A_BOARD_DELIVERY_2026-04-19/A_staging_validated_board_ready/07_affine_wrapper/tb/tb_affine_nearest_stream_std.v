...
module tb_affine_nearest_stream_std;
    ...
    begin
        ...
        while (!m_valid) begin
            ...
            if (wait_cycles > 64) begin
                $fatal(1, "Timed out waiting for affine output.");
            end
        end
    end
endtask
...
task expect_output_pixel;
    ...
    begin
        wait_for_output();
        check_current_output(pixel, sof, eol, eof);
        @(negedge clk);
        m_ready = 1'b1;
        @(posedge clk);
        @(negedge clk);
...
initial begin
    ...
    expect_output_pixel(24'h000003, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h000004, 1'b0, 1'b1, 1'b0);
    stall_and_expect_pixel(24'h000005, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h000006, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h000007, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h000008, 1'b0, 1'b1, 1'b0);
    expect_output_pixel(24'h000009, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h00000A, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h00000B, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h00000C, 1'b0, 1'b1, 1'b0);
    expect_output_pixel(24'h00000D, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h00000E, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h00000F, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h000010, 1'b0, 1'b1, 1'b1);
    ...
    expect_output_pixel(24'h000006, 1'b1, 1'b0, 1'b0);
    expect_output_pixel(24'h000007, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h000008, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h000000, 1'b0, 1'b1, 1'b0);
    expect_output_pixel(24'h00000A, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h00000B, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h00000C, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h000000, 1'b0, 1'b1, 1'b0);
    expect_output_pixel(24'h00000E, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h00000F, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h000010, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h000000, 1'b0, 1'b1, 1'b0);
    expect_output_pixel(24'h000000, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h000000, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h000000, 1'b0, 1'b0, 1'b0);
    expect_output_pixel(24'h000000, 1'b0, 1'b1, 1'b1);

    $display("tb_affine_nearest_stream_std passed.");
    $finish;
end
