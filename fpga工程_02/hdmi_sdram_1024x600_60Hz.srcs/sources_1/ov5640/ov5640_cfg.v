...
//parameter define
parameter   REG_NUM         =   260         ;   //总共需要配置的寄存器个数
...
reg     [8:0]   reg_num     ;   //配置寄存器索引, needs 9 bits for 260 entries
...
assign  cfg_data_reg[207]  =       {16'h3008, 8'h42};
assign  cfg_data_reg[208]  =       {16'h3035, 8'h21};
assign  cfg_data_reg[209]  =       {16'h3036, 8'h54};

assign  cfg_data_reg[210]  =       {16'h3c07, 8'h07};
assign  cfg_data_reg[211]  =       {16'h3820, 8'h40};
assign  cfg_data_reg[212]  =       {16'h3821, 8'h00};
assign  cfg_data_reg[213]  =       {16'h3814, 8'h11};
assign  cfg_data_reg[214]  =       {16'h3815, 8'h11};
assign  cfg_data_reg[215]  =       {16'h3800, 8'h01};
assign  cfg_data_reg[216]  =       {16'h3801, 8'h50};
assign  cfg_data_reg[217]  =       {16'h3802, 8'h01};
assign  cfg_data_reg[218]  =       {16'h3803, 8'hb2};
assign  cfg_data_reg[219]  =       {16'h3804, 8'h08};

assign  cfg_data_reg[220]  =       {16'h3805, 8'hef};
assign  cfg_data_reg[221]  =       {16'h3806, 8'h05};
assign  cfg_data_reg[222]  =       {16'h3807, 8'hf2};
assign  cfg_data_reg[223]  =       {16'h3808, 8'h07};
assign  cfg_data_reg[224]  =       {16'h3809, 8'h80};
assign  cfg_data_reg[225]  =       {16'h380a, 8'h04};
assign  cfg_data_reg[226]  =       {16'h380b, 8'h38};
assign  cfg_data_reg[227]  =       {16'h380c, 8'h09};
assign  cfg_data_reg[228]  =       {16'h380d, 8'hc4};
assign  cfg_data_reg[229]  =       {16'h380e, 8'h04};

assign  cfg_data_reg[230]  =       {16'h380f, 8'h60};
assign  cfg_data_reg[231]  =       {16'h3810, 8'h00};
assign  cfg_data_reg[232]  =       {16'h3811, 8'h10};
assign  cfg_data_reg[233]  =       {16'h3812, 8'h00};
assign  cfg_data_reg[234]  =       {16'h3813, 8'h04};
assign  cfg_data_reg[235]  =       {16'h3612, 8'h2b};
assign  cfg_data_reg[236]  =       {16'h3708, 8'h64};
assign  cfg_data_reg[237]  =       {16'h3a02, 8'h04};
assign  cfg_data_reg[238]  =       {16'h3a03, 8'h60};
assign  cfg_data_reg[239]  =       {16'h3a08, 8'h01};

assign  cfg_data_reg[240]  =       {16'h3a09, 8'h50};
assign  cfg_data_reg[241]  =       {16'h3a0a, 8'h01};
assign  cfg_data_reg[242]  =       {16'h3a0b, 8'h18};
assign  cfg_data_reg[243]  =       {16'h3a0e, 8'h03};
assign  cfg_data_reg[244]  =       {16'h3a0d, 8'h04};
assign  cfg_data_reg[245]  =       {16'h3a14, 8'h04};
assign  cfg_data_reg[246]  =       {16'h3a15, 8'h60};
assign  cfg_data_reg[247]  =       {16'h4713, 8'h02};
assign  cfg_data_reg[248]  =       {16'h460b, 8'h37};
assign  cfg_data_reg[249]  =       {16'h460c, 8'h20};

assign  cfg_data_reg[250]  =       {16'h3824, 8'h04};
assign  cfg_data_reg[251]  =       {16'h4004, 8'h06};

assign  cfg_data_reg[252]  =       {16'h4407, 8'h04};
assign  cfg_data_reg[253]  =       {16'h5001, 8'ha3};
assign  cfg_data_reg[254]  =       {16'h3008, 8'h02};
assign  cfg_data_reg[255]  =       {16'h3503, 8'h00};
assign  cfg_data_reg[256]  =       {16'h503d, 8'h00};
assign  cfg_data_reg[257]  =       {16'h3618, 8'h04};
assign  cfg_data_reg[258]  =       {16'h3709, 8'h12};
assign  cfg_data_reg[259]  =       {16'h370c, 8'h00};
//-------------------------------------------------------
