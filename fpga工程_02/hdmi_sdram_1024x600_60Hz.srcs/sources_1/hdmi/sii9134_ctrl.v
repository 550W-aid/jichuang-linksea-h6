...
(
    ...
    function [31:0] init_entry;
        ...
        begin
            case (index)
                // 1024x600 RGB888 separate-sync configuration.
                // Keep the longer, board-verified init path and update the
                // SiI9134 DE generator geometry to match the FPGA timing:
                // H start = HSYNC + HBP = 136 + 160 = 296
                // V start = VSYNC + VBP = 3 + 21 = 24
                // Active area = 1024 x 600
                ...
                8'd12: init_entry = {1'b0, 7'd0, 8'h32, 8'h28, 8'h00};
                8'd13: init_entry = {1'b0, 7'd0, 8'h33, 8'h71, 8'h00};
                8'd14: init_entry = {1'b0, 7'd0, 8'h34, 8'h18, 8'h00};
                8'd15: init_entry = {1'b0, 7'd0, 8'h36, 8'h00, 8'h00};
                8'd16: init_entry = {1'b0, 7'd0, 8'h37, 8'h04, 8'h00};
                8'd17: init_entry = {1'b0, 7'd0, 8'h38, 8'h58, 8'h00};
                8'd18: init_entry = {1'b0, 7'd0, 8'h39, 8'h02, 8'h00};
