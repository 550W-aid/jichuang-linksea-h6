module sdram_top(
    ...
    output  wire    dbg_sdram_wr_req,
    output  wire    dbg_sdram_wr_ack,
    output  wire    dbg_sdram_rd_req,
    output  wire    dbg_sdram_rd_ack
);
    ...
    assign dbg_sdram_wr_req = sdram_wr_req;
    assign dbg_sdram_wr_ack = sdram_wr_ack;
    assign dbg_sdram_rd_req = sdram_rd_req;
    assign dbg_sdram_rd_ack = sdram_rd_ack;
